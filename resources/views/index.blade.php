...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/template/css/normalize.min.css') }}">
    <link rel="stylesheet" href="{{ url('/template/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ url('/template/css/animate.css') }}">
    <link rel="stylesheet" href="{{ url('/template/css/templatemo_misc.css') }}">
    <link rel="stylesheet" href="{{ url('/template/css/templatemo_style.css') }}">

    <script src="{{ url('/template/js/vendor/modernizr-2.6.2.min.js') }}"></script>
...
<body>
            ...
            <div class="col-md-4 col-sm-12">
                <div class="sidebar-menu">
                    ...
                    <div class="logo-wrapper">
                        <h1 class="logo">
                            <img src="{{ url('/images/logo.png') }}" alt="Circle Template" width="150">
                            <span>Photo Marketplace</span>
                        </h1>
                    </div> <!-- /.logo-wrapper -->
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="member-item">
                                    <div class="thumb">
                                        <img src="{{ url('/template/images/team/member-1.jpg') }}" alt="Tanya - Web Designer">
                                    </div>
                                    <h4>Tanya</h4>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="member-item">
                                    <div class="thumb">
                                        <img src="{{ url('/template/images/team/member-2.jpg') }}" alt="Candy - Web Developer">
                                    </div>
                                    <h4>Candy</h4>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="member-item">
                                    <div class="thumb">
                                        <img src="{{ url('/template/images/team/member-3.jpg') }}" alt="Julia - Creative Director">
                                    </div>
                                    <h4>Julia</h4>
                    ...
                    <div id="menu-3" class="gallery content">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g1.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g1.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g2.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g2.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g3.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g3.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g4.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g4.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g5.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g5.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g6.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g6.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g7.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g7.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g8.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g8.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="{{ url('/template/images/gallery/g9.jpg') }}" alt="">
                                    <a data-rel="lightbox" class="overlay" href="{{ url('/template/images/gallery/g9.jpg') }}">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
    ...
    <script src="{{ asset('/template/js/vendor/jquery-1.10.1.min.js') }}"></script>
    <script>
        window.jQuery || document.write('<script src="{{ asset('/template/js/vendor/jquery-1.10.1.min.js') }}"><\/script>')
    </script>
        ...
        jQuery(function ($) {
            ...
            $.supersized({
                ...
                slides: [ // Slideshow Images
                    {
                        image: '{{ url('/template/images/templatemo-slide-1.jpg') }}'
                    }, {
                        image: '{{ url('/template/images/templatemo-slide-2.jpg') }}'
                    }, {
                        image: '{{ url('/template/images/templatemo-slide-3.jpg') }}'
                    }, {
                        image: '{{ url('/template/images/templatemo-slide-4.jpg') }}'
                    }
                ]
    ...
    <script src="{{ url('/template/js/vendor/jquery.gmap3.min.js') }}"></script>
    <!-- Google Map Init-->
    <script type="text/javascript">
